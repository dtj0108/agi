 ...
 *   node scripts/install-daemon.js --status
 */
...
Examples:
  node scripts/install-daemon.js              # Install daemon
  node scripts/install-daemon.js --status     # Check status
  node scripts/install-daemon.js --uninstall  # Remove daemon
`);
}
...
ExecStart=/usr/bin/node ${PROJECT_ROOT}/src/index.js
Restart=always
RestartSec=10
