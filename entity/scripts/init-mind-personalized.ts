...
async function createIdentityFiles(mindPath: any, userProfile: any, entityProfile: any, timestamp: any) {
  // self.md
...
async function createMemoryFiles(mindPath: any, userProfile: any, timestamp: any) {
  // Create directories
...
${userProfile.helpAreas.map((a: any) => `- ${a}`).join('\n')}
...
async function createThoughtFiles(mindPath: any, userProfile: any, entityProfile: any, timestamp: any) {
...
async function createGoalFiles(mindPath: any, userProfile: any, entityProfile: any) {
...
async function createEmotionFiles(mindPath: any, userProfile: any, timestamp: any) {
...
async function createWorldFiles(mindPath: any, userProfile: any, entityProfile: any, llmConfig: any, deployConfig: any, timestamp: any) {
...
async function createMetaFiles(mindPath: any, userProfile: any, date: any) {
...
async function createSelfFiles(mindPath: any, userProfile: any, entityProfile: any, timestamp: any, date: any) {
...
async function createActionFiles(mindPath: any, entityProfile: any) {
...
async function createSecurityFiles(mindPath: any, timestamp: any) {
...
async function createWorkspaceDirectories(projectRoot: any) {
  const dirs = [
...
async function initGit(mindPath: any) {
...
async function createConfigFile(projectRoot: any, userProfile: any, entityProfile: any, llmConfig: any, deployConfig: any) {
  const configPath = join(projectRoot, 'config', 'local.js');
  ensureDir(dirname(configPath));
  const authSection = llmConfig.auth
    ? `\n  auth: ${JSON.stringify(llmConfig.auth, null, 2).replace(/\n/g, '\n  ')},`
    : '';
...
export default {
  llm: {
    ...
    credentialSource: '${llmConfig.credentialSource || 'auto'}',
