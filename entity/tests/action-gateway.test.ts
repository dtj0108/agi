...
describe('Action Gateway Permissions', () => {
  describe('classifyTier', () => {
    ...
    it('classifies autonomy status reads as Tier 1', () => {
      const tier = classifyTier({ tool: 'config', params: { setting: 'autonomy.status' } });
      assert.strictEqual(tier, 1);
    });
    ...
    it('classifies autonomy mode updates as Tier 2', () => {
      const tier = classifyTier({ tool: 'config', params: { setting: 'autonomy.mode' } });
      assert.strictEqual(tier, 2);
    });
  ...
  describe('executeAction approvals', () => {
    it('requires explicit approval for tier-4 skill actions', async (t: any) => {
      const executed: any[] = [];
    ...
    it('requires approval for tier-2 actions in conservative mode', async (t: any) => {
    ...
    it('auto-approves tier-2 actions in balanced mode', async (t: any) => {
    ...
    it('auto-approves tier-4 actions in full_trust mode', async (t: any) => {
