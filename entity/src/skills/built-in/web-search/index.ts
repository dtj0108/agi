...
export default class WebSearchSkill extends BaseSkill {
  ...
  async search({ query, engine = 'duckduckgo', limit = 5 }: any) {
   ...
   */
  async searchDuckDuckGo(query: any, limit: any) {
   ...
   */
  async searchDuckDuckGoHTML(query: any, limit: any) {
   ...
   */
  async searchGoogle(query: any, limit: any) {
