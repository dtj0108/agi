 ...
 */
function hasCommandSubstitution(cmd: any) {
 ...
 */
function detectUnsupportedShellSyntax(cmd: any) {
 ...
 */
function splitOnChains(cmd: any) {
  const segments: any[] = [];
  let current = '';
  let inSingleQuote = false;
  let inDoubleQuote = false;
 ...
 */
function extractRedirectionTargets(cmd: any) {
  const targets: any[] = [];
 ...
 */
function isBlockedPath(path: any) {
 ...
 */
export function resolveBinaryPath(binary: any) {
