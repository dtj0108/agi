...
export class SecurityLogger {
   ...
   */
  logAction(action: any, result: any) {
    const entry = {
   ...
   */
  logRejection(action: any, reason: any) {
    const entry = {
      timestamp: new Date().toISOString(),
      type: 'REJECTION',
      tool: action.tool,
   ...
   */
  logSecurityEvent(eventType: any, details: any) {
   ...
   */
  logApprovalRequest(actionId: any, action: any) {
   ...
   */
  logApprovalDecision(actionId: any, approved: any, reason: any) {
   ...
   */
  summarize(text: any, maxLength: any) {
    if (!text) return null;
