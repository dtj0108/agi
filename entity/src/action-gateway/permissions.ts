 ...
 */
export function classifyTier(action: any) {
  switch (action.tool) {
    case 'shell':
 ...
 */
function classifySkillTier(params: any) {
 ...
 */
function classifyConfigTier(params: any) {
 ...
 */
function classifyShellTier(command: any) {
 ...
 */
function classifyBrowserTier(params: any) {
 ...
 */
function classifyFileTier(params: any) {
 ...
 */
function parseCommandSimple(command: any) {
 ...
 */
export function isBlocked(action: any, blockedPatterns: any = []) {
