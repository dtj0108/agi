...
export class PromptBuilder {
   ...
   */
  buildSystemPrompt(context, phase) {
...
${PHASE_INSTRUCTIONS[phase] || ''}`;
   ...
   */
  buildCachedPrompt(context, phase) {
    return [
...
Create a plan to accomplish this intent.`,
   ...
   */
  buildReflectMessages(thought, plan, observations) {
    return [{
      role: 'user',
