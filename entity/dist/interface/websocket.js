...
export class WebSocketInterface extends EventEmitter {
    ...
    config;
    wss;
    constructor(config, cognitiveEngine, actionGateway) {
        super();
        this.config = config;
    ...
    start() {
        ...
        this.cognitiveEngine.on('emotion', (state) => {
            this.broadcast({
                type: 'emotion',
                state,
            });
        });
        this.cognitiveEngine.on('cycle:start', (data) => {
            this.broadcast({
                type: 'cycle_start',
                cycleId: data.cycleId,
        ...
        this.cognitiveEngine.on('cycle:complete', (data) => {
            this.broadcast({
                type: 'cycle_complete',
                cycleId: data.cycleId,
        ...
        this.actionGateway.on('approval_required', (data) => {
        ...
        this.actionGateway.on('notification', (data) => {
            this.broadcast({
                type: 'notification',
                ...data,
            });
     ...
     */
    broadcastApprovalNeeded(payload) {
        this.broadcast({
