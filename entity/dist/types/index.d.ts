...
export type StimulusType = 'user_message' | 'heartbeat' | 'file_change' | 'approval_result' | 'system';
...
export type WSClientMessageType = 'message' | 'approve' | 'deny' | 'subscribe' | 'ping';
export type WSServerMessageType = 'connected' | 'response' | 'thought' | 'emotion' | 'cycle_start' | 'cycle_complete' | 'approval_needed' | 'approval_result' | 'notification' | 'pong' | 'error';
